...
public class PeerMessageTest {
	...
	public static void main(String[] args) throws IOException {
		...
		PeerMessage msgOut = new PeerMessage(PeerMessageOps.DOWNLOAD_FILE);
		//msgOut.setHash(hash);
		//msgOut.setFileName(name);
		//PeerMessage msgOut = new PeerMessage(PeerMessageOps.FILE, data);
		...
		case PeerMessageOps.DOWNLOAD_FILE:
			...
			System.out.println("out file name: " + new String(msgOut.getFileName()));
			System.out.println("in file name: " + new String(msgIn.getFileName()));

			if (msgOut.getOpcode() != msgIn.getOpcode()) {
				System.err.println("Opcode does not match!");
			} else if (!Arrays.equals(msgOut.getHash(), msgIn.getHash())) {
				System.err.println("Hash does not match!");
			} else if (!Arrays.equals(msgOut.getFileName(), msgIn.getFileName())) {
		...
		case PeerMessageOps.FILE:
			System.out.println("out code: " + msgOut.getOpcode());
			System.out.println("in code: " + msgIn.getOpcode());
			System.out.println("out data: " + new String(msgOut.getFileData()));
			System.out.println("in data: " + new String(msgOut.getFileData()));
